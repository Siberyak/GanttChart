...
namespace Braincase.GanttChart
{
    ...
    public partial class Chart : UserControl
    {
        ...
        /// </summary>
        public static TaskFormat DefaultTaskFormat = new GanttChart.TaskFormat()
        {
            Color = Brushes.Black,
            Border = Pens.Maroon,
        ...
        /// </summary>
        public static readonly TaskFormat DefaultCriticalTaskFormat =
            new GanttChart.TaskFormat()
            {
                Color = Brushes.Black,
                Border = Pens.Maroon,
    ...
    public Chart()
        ...
        private int _DrawTasks(Graphics graphics, Rectangle clipRect)
        {
            ...
            {
                var taskFormatProvider = _mProject.ResourcesOf(task).OfType<ITaskFormatProvider>().FirstOrDefault();

                var criticalTaskFormat = taskFormatProvider?.CriticalTaskFormat ?? DefaultCriticalTaskFormat;
                var taskFormat = taskFormatProvider?.TaskFormat ?? DefaultTaskFormat;
                ...
                if (taskrect.Left <= viewRect.Right)
                {
                    ...
                    if (critical) e = new TaskPaintEventArgs(graphics, clipRect, this, task, row, critical, this.Font, criticalTaskFormat);
                    else e = new TaskPaintEventArgs(graphics, clipRect, this, task, row, critical, this.Font, taskFormat);
    ...
    public interface ITaskFormatProvider
    {
        ...
        /// Get or set format for Tasks
        /// </summary>
        TaskFormat TaskFormat { get; }

        /// <summary>
        /// Get or set format for critical Tasks
        /// </summary>
        TaskFormat CriticalTaskFormat { get; }
    }
}
